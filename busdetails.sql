...
-- List every column for buses operated by Neeta Travels ---
...
-- 11.	Return BusNumber and OperatorName for buses whose destination city is in (Goa, Nagpur, Hyderabad).
		select  busnumber, operatorName, destinationCity from Busdetails  where destinationCity in ('goa','nagpur','hydrabad');
...
select * from busdetails where bustype = 'sleeper' and arrivaltime >= '06:00';
